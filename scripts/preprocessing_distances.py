...
if os.path.exists(f"{dir_name}{output_dir}cbd_distance.json"):
    cbd_dict = json.load(open(f"{dir_name}{output_dir}cbd_distance.json"))
...
for token in tokens:    
    for category in category_ids:
        ...
        for index in range(x,y):
            if ((category == 280)&(index in manual_parks))|((category == 604)&(index in manual_ptv)):
                amenities_dict[category][str(index)] = 0
            else:
                amenities_dict = find_poi(property_data, index, token, buffer_size, category, amenities_dict)

## manual input
if os.path.exists(f"{dir_name}{output_dir}nearby_amenities.json"): # ie second/last run to not screw lengths
    cbd_dict['10497'] = {'distance': 295100.0, 'duration': 13050.05}
    cbd_dict['10561'] = {'distance': 36300.0, 'duration': 2070.0}
    amenities_dict[280]['10561'] = {'distance': 1200.0, 'duration': 240.0}
    amenities_dict[604]['10561'] = {'distance': 1300.0, 'duration': 180.0}
    cbd_dict['10581'] = {'distance': 36200.0, 'duration': 2016.0}
    amenities_dict[280]['10581'] = {'distance': 1000.0, 'duration': 240.0}
    amenities_dict[604]['10581'] = {'distance': 1100.0, 'duration': 120.0}
    cbd_dict['10590'] = {'distance': 36250.0, 'duration': 2010.0}
    amenities_dict[280]['10590'] = {'distance': 800.0, 'duration': 180.0}
    amenities_dict[604]['10590'] = {'distance': 900.0, 'duration': 120.0}
    cbd_dict['10591'] = {'distance': 36300.0, 'duration': 2070.0}
    amenities_dict[280]['10591'] = {'distance': 1200.0, 'duration': 240.0}
    amenities_dict[604]['10591'] = {'distance': 1300.0, 'duration': 180.0}
    ...
    amenities_dict[280]['12047'] = {'distance': 3200.0, 'duration': 360.0}
    amenities_dict[280]['12715'] = {'distance': 1300.0, 'duration': 180.0}
    amenities_dict[280]['12717'] = {'distance': 1300.0, 'duration': 180.0}
    cbd_dict['12797'] = {'distance': 82700.0, 'duration': 66.3}
    amenities_dict[280]['12797'] = {'distance': 1600.0, 'duration': 180.0}

## write json
for category in category_ids:
    property_data['Closest_Park'] = amenities_dict[280]
    property_data['Closest_Post_Office'] = amenities_dict[370]
    property_data['Closest_Railway_Station'] = amenities_dict[604]
